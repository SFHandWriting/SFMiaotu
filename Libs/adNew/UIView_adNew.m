...
-(void)detail:(UIButton *)button{
    NSInteger n=button.tag-200;
    topicViewController *topic = [[topicViewController alloc]init];
    topic.tid = self.tidArray[button.tag-200];
    topic.token = @"98aa550d-6758-11e5-bb24-00163e002e59";
    topic.hidesBottomBarWhenPushed = YES;
    [self.fVC.navigationController pushViewController:topic animated:YES];
}
